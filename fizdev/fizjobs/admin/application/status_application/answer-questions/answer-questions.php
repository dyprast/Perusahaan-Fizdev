<section class="container">
	<div class="content">
		<div class="header">
			<h2>Data pelamar Menjawab Pertanyaan Wawancara</h2>
		</div>
	...
	<?php 
		if (isset($_POST['show'])) {
			...
			elseif ($select_jobs == "show-all") {
				$q = mysqli_query($conn, "SELECT * FROM application_file WHERE status = 'Menunggu Jawaban Dari Pertanyaan Admin' ORDER BY id");
	 ?>
				...
				<div class="col-12 col-md-6">
					<div class="cards">
						...
						<div class="action-cards">
							<a href="./?application_status☺=detail@answer-questions&application_id=<?php echo $results['id']; ?>" class="btn btn-primary">Detail</a>
						</div>
					</div>
				</div>
			<?php } ?>
