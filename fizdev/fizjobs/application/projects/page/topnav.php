			...
			<div class="row">
				...
				<div class="col-12 col-md-6">
					<div class="navbar" id="show_menu">
						<ul>
							<li>
								<a href="projects/page/vacancies">Lowongan</a>
							</li>
							<?php
								if (!isset($_SESSION['logged'])) {
							 ?>
							<li>
								<a href="projects/page/accounts/login">Masuk</a>
							</li>
							<li>
								<a href="projects/page/accounts/register">Mendaftar</a>
							</li>
							<?php 
								}
								else{
							 ?>
							 <li>
							 	<a href="projects/page/accounts/home/?<?php echo $_SESSION['validation_account']; ?>=<?php echo $_SESSION['id_account']; ?>">Account</a>
							 </li>
							 <li>
...
<script type="text/javascript">
	document.getElementById('logoutConf').onclick = function(){
		...
		if (conf == true) {
			window.location = "projects/page/accounts/logout.php";
		}
	}
